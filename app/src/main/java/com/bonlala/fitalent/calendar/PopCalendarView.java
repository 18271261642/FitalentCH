...
//        }
        ...
        if (monthDataListen != null) {
            String strMonth = mRightNow.get(Calendar.YEAR) + BikeUtils.formatTwoStr(mRightNow.get(Calendar.MONTH));
    ...
    public void goCurrentMonth() {
        ...
        requestLayout();
        if (monthDataListen != null) {
            String strMonth = mHelper.getYear() + BikeUtils.formatTwoStr(mHelper.getMonth());
            monthDataListen.getMontData(strMonth);
        }
