 ...
 * Date 2020/7/17
 */
public class CustomerScrollView extends View {
    ...
    public CustomerScrollView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initPaint(context);
        gestureDetector = new GestureDetector(context, new CusOnGestureListener());
    }

    public CustomerScrollView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initPaint(Context context) {
        ...
        mBarPaint.setStrokeWidth(MiscUtil.dipToPx(context,2f));
...
//        if(xValues.size() == 7 || xValues.size() == 13){
//            float tmpIntervalX = xValues.size() == 13 ? mWidth / 14 : mWidth/ 7;
//            for(int i = 0;i<xValues.size();i++){
//                Map<String,Integer> tmpMap = sourceList.get(i);
//                RectF rectF = new RectF( tmpIntervalX * i + mCurrentWidth ,-(tmpMap.get(xValues.get(i)) * modulsValue)  - dp2px(15), tmpIntervalX * i + mCurrentWidth  + dp2px(6) , - dp2px(15));
//                canvas.drawRect(rectF, mBarPaint);
//
//                //汇总数值显示
//                float xV = tmpIntervalX * i + mCurrentWidth -(MiscUtil.getTextWidth(mBarPaint,tmpMap.get(xValues.get(i))+"")/2);
//                float yV = (tmpMap.get(xValues.get(i)) * modulsValue) + dp2px(18);
//                canvas.drawText(tmpMap.get(xValues.get(i))+"",xV,-yV, mBarPaint);
//
//                if(xValues.size() == 13 ){
//                    if(i % 2 == 0){
//                        canvas.drawText(xValues.get(i)+"",tmpIntervalX * i + mCurrentWidth-((MiscUtil.getTextWidth(mBarPaint,xValues.get(i)))/2),-(MiscUtil.measureTextHeight(mBarPaint))/2,mBarPaint);
//                    }
//                }else{
//                    canvas.drawText(xValues.get(i)+"",tmpIntervalX * i + mCurrentWidth-((MiscUtil.getTextWidth(mBarPaint,xValues.get(i)))/2),-(MiscUtil.measureTextHeight(mBarPaint))/2,mBarPaint);
//                }
